...
get_ipython().run_line_magic('sql', 'ibm_db_sa://jqv77754:hcg@sfkcm5v1dzs5@dashdb-txn-sbox-yp-dal09-04.services.dal.bluemix.net:50000/BLUDB')
...
get_ipython().run_line_magic('sql', "select TABSCHEMA, TABNAME, CREATE_TIME from SYSCAT.TABLES where TABSCHEMA='jqv77754'")
...
get_ipython().run_line_magic('sql', 'SELECT Name_of_School, Average_Student_Attendance       from SCHOOLS      order by Average_Student_Attendance      LIMIT 5')
...
get_ipython().run_line_magic('sql', "SELECT Name_of_School, REPLACE(Average_Student_Attendance, '%', '')      from SCHOOLS      order by Average_Student_Attendance      LIMIT 5")
